...
operational_cost_for_one_server = (budget / one_server_cost_per_day)

print("A server can operate on ${1:.2f} for {0:.0f} days  " .format(operational_cost_for_one_server,budget))
